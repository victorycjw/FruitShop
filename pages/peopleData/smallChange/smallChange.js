// pages/peopleData/smallChange/smallChange.js
const app = getApp()
...
Page({
  ...
  // 零钱
  toSmallChangeDetail:function(e){
    var type = e.currentTarget.dataset.type
    wx.navigateTo({
      url: '../smallChangeDetail/smallChangeDetail?type=' + type,
    })
  },
  ...
  toBalance:function(){
    wx.navigateTo({
      url: '../changeToBalance/changeToBalance',
    })
  }
})